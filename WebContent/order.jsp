...
<html>
  ...
  <div class="top"> 
   <div class="topbar"> 
    <span class="welcome" style="float:left">欢迎光临宅商城系统 <a href="" class="red">${user.userName }</a>,<a rel="nofollow" href="${pageContext.request.contextPath}/UserServlet?type=mainOut">退出</a> </span> 
...
url:'${pageContext.request.contextPath}/AddressServlet?type=addAddress', //发送数据的地址
...
function getvv(){
	...
	return group[i].value;
     ...
     <!--收货信息 结束--> 
     <!--订单支付 开始--> 
     <form action="${pageContext.request.contextPath}/OrderServlet?type=submitOrder" method="post" name="myform" id="myform"> 
      <div class="orderplace"> 
       <div class="o_title"> 
        <h2>支付</h2> 
       </div> 
