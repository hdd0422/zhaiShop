...
<dl>
<dd><a rel="nofollow" href="${pageContext.request.contextPath}/PageServlet?type=myOrder" <c:if test="${rightPage=='orderAll' || rightPage=='orderDetail' }">class="current"</c:if>>我的订单</a></dd>
<dd><a rel="nofollow" href="${pageContext.request.contextPath}/CollectServlet?type=myCollect" <c:if test="${rightPage=='MyCollect' }">class="current"</c:if>>我的收藏</a></dd>
</dl>
...
<dd><a href="${pageContext.request.contextPath}/PageServlet?type=userData" <c:if test="${rightPage=='userData' }">class="current"</c:if>>个人档案</a></dd>
<dd><a rel="nofollow" href="${pageContext.request.contextPath}/PageServlet?type=userAddress" <c:if test="${rightPage=='address' || rightPage=='addAddress' }">class="current"</c:if>>地址管理</a></dd>

<dd><a rel="nofollow" href="${pageContext.request.contextPath}/CartServlet?type=myCart">我的购物车</a></dd>
<dd><a rel="nofollow" href="${pageContext.request.contextPath}/PageServlet?type=goChangePassword" <c:if test="${rightPage=='changePassword' }">class="current"</c:if>>修改密码</a></dd>
