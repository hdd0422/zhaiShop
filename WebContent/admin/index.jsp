		...
		<form action="${pageContext.request.contextPath}/LoginServlet" method="post">
			<div class="log">
				...
				<div class="pwd">
					...
					<label>验证码</label><input type="text" class="text" id="value_1" placeholder="验证码" name="jyzm" tabindex="3" style="margin-top: 10px;width: 100px;"><img id="CreateCheckCode" src="${pageContext.request.contextPath}/ImageServlet" onclick="changeImage()">
