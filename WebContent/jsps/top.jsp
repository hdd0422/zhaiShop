		...
		<div class="topaccount">
			<span class="operate_nav"> <span id="userfavor"><a
				...
				<ul id="favormenu" class="top_lg_info_down" style="display: none;">
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/CollectServlet?type=myCollect">收藏的商品</a></li>
				</ul>
				...
				<ul id="dbox" class="top_lg_info_down" style="display: none;">
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/PageServlet?type=userCenter">个人中心</a></li>
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/PageServlet?type=goChangePassword">修改密码</a></li>
				</ul> |
				...
				<ul id="sellmenu" class="top_lg_info_down" style="display: none;">
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/PageServlet?type=myOrder&flag=1">所有订单</a></li>
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/PageServlet?type=myOrder&flag=2">待支付订单</a></li>
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/PageServlet?type=myOrder&flag=3">待发货订单</a></li>
					<li><a rel="nofollow"
						href="${pageContext.request.contextPath}/PageServlet?type=myOrder&flag=4">待确认订单</a></li>
				</ul> |
			</span>
			<c:if test="${user.userName!=null }">
				<span class="operate_nav"> 欢迎光临宅商城 <a href="" class="red">${user.userName}</a>,<a
					rel="nofollow"
					href="${pageContext.request.contextPath}/LoginOutServlet">退出</a> |
				</span>
			</c:if>
			<c:if test="${user.userName==null }">
				<span class="operate_nav"> 欢迎光临宅商城 ,请<a
					href="${pageContext.request.contextPath}/login.jsp">[登录]</a>&nbsp;<a
					href="${pageContext.request.contextPath}/rege.jsp"
