		...
		laypage({
		    ...
		    jump: function(e, first){ //触发分页后的回调
		        if(!first){ //一定要加此判断，否则初始时会无限刷新
		            location.href = '${pageContext.request.contextPath}/CollectServlet?type=myCollect&page='+e.curr;
		        }
		    }
		});
		function delCoolect(id){
			...
			layer.confirm('确定要删除此条收藏吗？', {title:'删除收藏',icon: 3,shift:6,
				...
				$.ajax({
					...
					url:'${pageContext.request.contextPath}/CollectServlet?type=deleteCollect', //发送数据的地址
					data:{id:id},
					 dataType: "json",
