...
<div class="center_right" id="MemberCenterCtrl" style="display: block;">
	...
	<form id="fro" class="form-horizontal" role="form" action="" method="post" style="width: 60%; margin: 0 auto;">
        		...
        		function (){
        			...
        			if($(':password:eq(1)').val()!=$(':password:eq(2)').val()){
        			 ...
        			 $.ajax({
        				...
        				url:'${pageContext.request.contextPath}/PageServlet?type=changePassword', //发送数据的地址
        				data:$('#fro').serialize(),
        				 dataType: "json",
