    ...
    <div class="mainwrap"> 
     <div class="think-form"> 
      <div class="loginform"> 
       <div class="hd"> 
        <strong>用户登录</strong>
        <span>已有帐号？点击<a href="${pageContext.request.contextPath}/rege.jsp">注册</a></span> 
       </div> 
       <a rel="nofollow" href="" class="img"><img src="images/login-3.jpg" width="400" height="300" /></a>
      </div>
      <div class="login-other"> 
       <form name="frm" class="form-horizontal login-user" action="${pageContext.request.contextPath}/UserServlet?type=mainLogin" id="loginform" name="user" method="post"> 
        ...
        <div class="control-group"> 
          ...
          <div class="controls"> 
          <img id="CreateCheckCode" src="${pageContext.request.contextPath}/ImageServlet">
